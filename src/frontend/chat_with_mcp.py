...
@st.cache_resource
def setup_chatbot():
    """Setup the LangGraph chatbot with memory"""
    ...
    # System message
    sys_msg = SystemMessage(content="""You are a helpful AI assistant. You can have natural conversations with users 
...
# Initialise session state for thread management
